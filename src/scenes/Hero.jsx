      ...
      <div className="two-col">
        <div>
          ...
          <div className="actions">
            <MagneticButton className="primary" onClick={() => api.goTo(2)}>✨ Open a booth <Arrow /></MagneticButton>
            <MagneticButton onClick={() => api.goTo(1)}>▶ See how it works <Play /></MagneticButton>
          </div>
        </div>
